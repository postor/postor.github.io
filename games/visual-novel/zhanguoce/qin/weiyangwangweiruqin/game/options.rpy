...
define config.name = _("秦策 卫鞅亡魏入秦")
...
define build.name = "shangyangruqin"
...
define config.save_directory = "shangyangruqin-1766882347"
...
transform bg_full:
    # Scale image to fill the screen (100% width, 100% height)
    xpos 0
    ypos 0
    xsize 1920  # Replace with your game resolution width
    ysize 1080  # Replace with your game resolution height

transform char_left:
    xpos 0.1  # left side
    ypos 0.35  # move slightly down
    xanchor 0.0
    yanchor 0.0
    zoom 0.8  # reduce size to 80% (adjust as needed)

...
## 游戏内文本使用的字体。
define gui.text_font = "SourceHanSerifCN-Medium.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "SourceHanSerifCN-Medium.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SourceHanSerifCN-Medium.ttf"
